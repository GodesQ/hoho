...
<body>
    <div class="container-xxl">
        <button class="btn btn-primary" id="test-btn">Test Location for MAKATI (3)</button>
    </div>
    ...
    <script>
        ...
        function sendLocationToServer() {
            ...
            CURRENT_LATITUDE = INITIAL_LATITUDE + 0.0012;
            CURRENT_LONGITUDE = INITIAL_LONGITUDE + 0.0012;
