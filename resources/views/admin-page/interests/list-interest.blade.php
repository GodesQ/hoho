...
<div class="container-xxl flex-grow-1 container-p-y">
    <section class="section-header d-flex justify-content-between align-items-center">
        <div class="title-section">
            <h4 class="fw-medium mb-2">Interests</h4>
            <h6 class="fw-medium text-primary"><a href="{{ route('admin.dashboard') }}"
                    class="text-muted fw-light">Dashboard /</a> Interests</h6>
        </div>
        <div class="action-section btn-group">
            <a href="{{ route('admin.interests.create') }}" class="btn btn-primary"><i class="bx bx-plus"></i> Add Interest</a>
        </div>
    </section>
        ...
        $(document).on("click", ".remove-btn", function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ route('admin.interests.destroy') }}",
                        method: "DELETE",
                        data: {
                            _token: "{{ csrf_token() }}",
                            id: id
