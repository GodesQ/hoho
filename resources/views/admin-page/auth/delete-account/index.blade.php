            ...
            <div class="authentication-inner">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p>Type in your email address, and it will send a code to your email for confirmation.</p>
                        @if(Session::get('fail'))
                            <div class="alert alert-danger">{{ Session::get('fail') }}</div>
                        @endif

                        <form id="formAuthentication" class="mb-3" action="{{ route('delete-account.post') }}"
                            method="POST">
                            @csrf
                            <div class="mb-3">
