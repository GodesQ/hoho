...
@section('title', 'Hop On Hop Off - Create Unavailable Date')

@section('content')
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="d-flex justify-content-between align-items-center">
        <h4 class="fw-bold py-3 mb-4">Create Unavailable Date</h4>
        <a href="{{ route('admin.unavailable_dates.list') }}" class="btn btn-dark"><i class="bx bx-undo"></i> Back to List</a>
    </div>

    <div class="card">
        <div class="card-body">
            <form action="{{ route('admin.unavailable_dates.store') }}" method="post">
                @csrf
                <div class="row">
                    <div class="col-lg-12">
                        <div class="mb-3">
                            <label for="" class="form-label">Unavailable Date</label>
                            <input type="date" class="form-control" name="unavailable_date" id="unavailable_date">
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="mb-3">
