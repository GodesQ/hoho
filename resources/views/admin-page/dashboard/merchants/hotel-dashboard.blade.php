                                ...
                                <li class="d-flex mb-4 pb-1">
                                    ...
                                    <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                        <div class="me-2">
                                            ...
                                            <h6 class="mb-0">
                                                <a href="{{ route('admin.hotel_reservations.edit', $recent_hotel_reservation->id) }}">{{ $recent_hotel_reservation->room->room_name ?? null }}</a>
                                            </h6>
                                        </div>
                                        <div class="user-progress text-end">
                                            ...
                                            <h6 class="mb-0 text-end">{{ $recent_hotel_reservation->number_of_pax }} Pax</h6>
                                        </div>
                                    </div>
                                </li>
                                @empty
