...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="d-flex justify-content-between align-items-center">
        <h4 class="fw-bold py-3 mb-4">Restaurants List</h4>
        <a href="{{ route('admin.merchants.restaurants.create') }}" class="btn btn-primary">Add Restaurant <i class="bx bx-plus"></i></a>
    </div>
