...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('admin.merchants.restaurants.list') }}" class="btn btn-dark"><i class="bx bx-undo"></i> Back to
                List</a>
        </div>
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.merchants.restaurants.update', $restaurant->id) }}" method="POST"
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <select name="type" id="type" class="form-select" required>
                                            <option {{ $restaurant->merchant->type == 'Restaurant' ? 'selected' : null }}
                                                value="Restaurant">Restaurant</option>
                                            <option {{ $restaurant->merchant->type == 'Hotel' ? 'selected' : null }}
                                                value="Hotel">Hotel</option>
                                            <option {{ $restaurant->merchant->type == 'Store' ? 'selected' : null }}
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="organization_id" id="organization_id" class="select2 form-select">
                                            ...
                                            @foreach ($organizations as $organization)
                                                <option
                                                    {{ $organization->id == $restaurant->merchant->organization_id ? 'selected' : null }}
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <hr>
                                    <h5><i class="bx bx-box"></i> Restaurant Information</h5>
                                    <hr>
                                </div>
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <select name="interests[]" id="interests" class="form-select select2" multiple>
                                            <?php $selected_interests = $restaurant->interests ? json_decode($restaurant->interests) : [] ?>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        <div class="form-check form-switch mb-2">
                                            <input class="form-check-input" type="checkbox" id="isActive" name="is_active" {{ $restaurant->merchant->is_active ? 'checked' : null }} />
                                            ...
                                            <div class="mb-3">
                                                @if (count($restaurant_images) > 0 && isset($restaurant_images[0]))
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        onclick="removeImageBtn({{ $restaurant->id }}, '{{ $restaurant_images[0] }}')">Remove
                                            ...
                                            <div class="mb-3">
                                                @if (count($restaurant_images) > 0 && isset($restaurant_images[1]))
                                                    ...
                                                    <button type="button"
                                                        style="display: block; width: 100%; border-radius: 0px 0px 20px 20px;"
                                                        class="btn btn-primary"
                                                        onclick="removeImageBtn({{ $restaurant->id }}, '{{ $restaurant_images[1] }}')">Remove
                                                        <i class="bx bx-trash"></i></button>
                                                @else
                                                    <input type="file" class="form-control mb-2 image-input"
                                            ...
                                            <div class="mb-3">
                                                @if (count($restaurant_images) > 0 && isset($restaurant_images[2]))
                                                    ...
                                                    <button type="button"
                                                        style="display: block; width: 100%; border-radius: 0px 0px 20px 20px;"
                                                        class="btn btn-primary"
                                                        onclick="removeImageBtn({{ $restaurant->id }}, '{{ $restaurant_images[2] }}')">Remove
                                                        <i class="bx bx-trash"></i></button>
                                                @else
                                                    <input type="file" class="form-control mb-2 image-input"
