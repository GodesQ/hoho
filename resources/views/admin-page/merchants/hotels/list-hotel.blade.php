...
<div class="container-xxl flex-grow-1 container-p-y">
    <section class="section-header d-flex justify-content-between align-items-center">
        <div class="title-section">
            <h4 class="fw-medium mb-2">Merchant Hotels</h4>
            <h6 class="fw-medium text-primary"><a href="{{ route('admin.dashboard') }}"
                    class="text-muted fw-light">Dashboard /</a> Merchant Hotels</h6>
        </div>
        <div class="action-section btn-group">
            <a href="{{ route('admin.merchants.hotels.create') }}" class="btn btn-primary"><i class="bx bx-plus"></i> Add Hotel</a>
        </div>
    </section>
