                                        ...
                                        <div class="col-lg-4">
                                            <div class="mb-3">
                                                ...
                                                @if(count($store_images) > 0 && isset($store_images[0]))
                                                    <img src="{{ URL::asset('assets/img/stores/' . $store->id . '/' . $store_images[0]) }}" id="previewImage1" alt="Default Image" width="100%" height="200px" style="border-radius: 10px 10px 0px 0px; object-fit: cover;">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="mb-3">
                                                ...
                                                @if(count($store_images) > 0 && isset($store_images[1]))
                                                    <img src="{{ URL::asset('assets/img/stores/' . $store->id . '/' . $store_images[1]) }}" id="previewImage2" alt="Default Image" width="100%" height="200px" style="border-radius: 10px 10px 0px 0px; object-fit: cover;">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="mb-3">
                                                ...
                                                @if(count($store_images) > 0 && isset($store_images[2]))
                                                    <img src="{{ URL::asset('assets/img/stores/' . $store->id . '/' . $store_images[2]) }}" id="previewImage3" alt="Default Image" width="100%" height="200px" style="border-radius: 10px 10px 0px 0px; object-fit: cover;">
