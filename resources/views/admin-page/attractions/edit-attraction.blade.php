                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="product_category_ids[]" id="product_category_ids" multiple class="select2 form-select">
                                        @foreach ($product_categories as $product_category)
                                            <option {{ in_array($product_category->id, $product_category_ids) ? 'selected' : null }} value="{{ $product_category->id }}">{{ $product_category->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            @if(count($attraction_images) > 0 && isset($attraction_images[0]))
                                                <img src="{{ URL::asset('assets/img/attractions/' . $attraction->id . '/' . $attraction_images[0]) }}" id="previewImage1" alt="Default Image" width="100%" height="200px" style="border-radius: 10px 10px 0px 0px; object-fit: cover;">
                                                <button type="button" style="display: block; width: 100%; border-radius: 0px 0px 20px 20px;" class="btn btn-primary" onclick="removeImageBtn({{ $attraction->id}}, '{{ $attraction_images[0] }}')">Remove <i class="bx bx-trash"></i></button>
                                            @else
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            @if(count($attraction_images) > 0 && isset($attraction_images[1]))
                                                <img src="{{ URL::asset('assets/img/attractions/' . $attraction->id . '/' . $attraction_images[1]) }}" id="previewImage2" alt="Default Image" width="100%" height="200px" style="border-radius: 10px 10px 0px 0px; object-fit: cover;">
                                                <button type="button" style="display: block; width: 100%; border-radius: 0px 0px 20px 20px;" class="btn btn-primary" onclick="removeImageBtn({{ $attraction->id}}, '{{ $attraction_images[1] }}')">Remove <i class="bx bx-trash"></i></button>
                                            @else
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            @if(count($attraction_images) > 0 && isset($attraction_images[2]))
                                                <img src="{{ URL::asset('assets/img/attractions/' . $attraction->id . '/' . $attraction_images[2]) }}" id="previewImage3" alt="Default Image" width="100%" height="200px" style="border-radius: 10px 10px 0px 0px; object-fit: cover;">
                                                <button type="button" style="display: block; width: 100%; border-radius: 0px 0px 20px 20px;" class="btn btn-primary" onclick="removeImageBtn({{ $attraction->id}}, '{{ $attraction_images[2] }}')">Remove <i class="bx bx-trash"></i></button>
                                            @else
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @if($attraction->featured_image)
                        <img src="{{ URL::asset('assets/img/attractions/' . $attraction->id . '/' . $attraction->featured_image) }}" id="previewImage" alt="{{ $attraction->name }}" width="100%" style="border-radius: 10px;">
                    @else
