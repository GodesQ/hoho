...
@section('title', 'Add Food Category - Philippine Hop On Hop Off')

@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="d-flex justify-content-between align-items-center">
            <h4 class="fw-bold py-3 mb-4">Create Food Category</h4>
            <a href="{{ route('admin.food_categories.index') }}" class="btn btn-dark"><i class="bx bx-undo"></i> Back to List</a>
        </div>
