                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="room_name" id="room_name" value="{{ old('room_name') }}">
                                        <span class="text-danger danger">@error('room_name'){{ $message }}@enderror</span>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <span class="text-danger danger">@error('merchant_id'){{ $message }}@enderror</span>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <span class="text-danger danger">@error('price'){{ $message }}@enderror</span>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <span class="text-danger danger">@error('image'){{ $message }}@enderror</span>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        <label for="available_pax" class="form-label">Available Pax <span class="text-danger">*</span></label>
                                        <input type="number" class="form-control" name="available_pax" id="available_pax" value="{{ old('available_pax') }}">
                                        <span class="text-danger danger">@error('available_pax'){{ $message }}@enderror</span>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="mb-3">
