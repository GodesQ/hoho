                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td bgcolor="#ffffff" align="center" valign="top"
                            ...
                            <h1 style="font-size: 30px; font-weight: 800; margin-bottom: 0;">DELETE MY ACCOUNT</h1>
                        </td>
                    </tr>
                </table>
            </td>
                    ...
                    <tr>
                        <td bgcolor="#ffffff" align="center">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td bgcolor="#ffffff" align="left" style="padding: 10px 20px 20px 20px;">
                                        <table border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td>
                                                    <div style="margin-bottom: 1rem;">
                                                        <div style="margin-left: 10px">By deleting your account, you will lose all of your information from our database.</div>
                                                        <div style="margin-left: 10px; margin-top: 10px;">Your OTP Code : <b>{{ $code }}</b></div>
                                                        <div style="margin-left: 10px; margin-top: 25px;">Hey {{ $email }}, we're sorry to see you go. After deleting your account, all of your details and related informations in our application will be deleted permanently.</div>
                                                    </div>
                                                </td>
                                            </tr>
                                        </table>
