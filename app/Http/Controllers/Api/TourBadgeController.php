...
class TourBadgeController extends Controller
{
    public function checkBadge(Request $request) {
        ...
        if($tour_reservation->tour_id != $tour_badge->tour_id) return response()->json(['status'=> FALSE, 'message'=> 'Tour is not same with the tour reservation you booked today.'],400);
